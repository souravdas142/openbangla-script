...
XMODIFIERS=@im=ibus
```
অনেক সময় ibus ওয়েল্যান্ড সেশানে উপর্যুক্ত এনভাইরনমেন্টাল ভ্যারিয়েবল সেট করলে এরর দেয়, সেক্ষেত্রে ```GTK_IM_MODULE=ibus ``` অংশটুকু শুধু রিমুভ করে দিলেই আর এরর মেসেজ শো করবে না।
